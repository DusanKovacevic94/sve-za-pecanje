...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "posts" (
  	...
  	"substantive_updated_at" timestamp(3) with time zone,
  	"marketplace_category_slug" varchar,
  	"internal_notes" varchar,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  ...
  CREATE TABLE "_posts_v" (
  	...
  	"version_marketplace_category_slug" varchar,
  ...
  -- Foundation accounts were all administrators. Preserve that access on upgrade;
  -- the new default remains editor for accounts created after this migration.
